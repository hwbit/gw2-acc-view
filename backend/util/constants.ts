export const TOKENINFO_URL = "https://api.guildwars2.com/v2/tokeninfo";
...
export const ACCOUNT_CHARACTERS = "account_characters";
export const ACCOUNT_BANK = "account_bank";
export const ACCOUNT_MATERIAL = "account_material";
export const ACCOUNT_SHARED_INVENTORY = "account_shared_inventory";
